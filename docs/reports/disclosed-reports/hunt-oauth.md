...
1. **Email Confirmation Bypass in myshop.myshopify.com that Leads to Full Privilege Escalation to Any Sho** — [Shopify](https://hackerone.com/reports/791775) — 1909 upvotes, —
2. **Able to Takeover Merchants Accounts Even They Have Already Setup SSO, After Bypassing the Email Conf** — [Shopify](https://hackerone.com/reports/796956) — 308 upvotes, —
3. **Ability to DOS any organization's SSO and open up the door to account takeovers** — [Superhuman (formerly Grammarly)](https://hackerone.com/reports/976603) — 255 upvotes, $10K
4. **Stealing SSO Login Tokens (snappublisher.snapchat.com)** — [Snapchat](https://hackerone.com/reports/265943) — 243 upvotes, $7,500
5. **HackerOne SAML signup domain enforcement bypass results in unauthorized access to HackerOne PullRequ** — [HackerOne](https://hackerone.com/reports/2101076) — 224 upvotes, —
6. **SAML Signature verification bypass allows logging into any user (with specific conditions)** — [GitHub](https://hackerone.com/reports/2579939) — 194 upvotes, —
7. **Insecure Zendesk SSO implementation by generating JWT client-side** — [Trint Ltd](https://hackerone.com/reports/638635) — 101 upvotes, —
8. **SAML Authentication Bypass on uchat.uberinternal.com** — [Uber](https://hackerone.com/reports/223014) — 87 upvotes, $8,500
9. **Twitter SSO allows unverified e-mail registration, leads to Slack and social media hijacks** — [Zendesk](https://hackerone.com/reports/235139) — 70 upvotes, —
10. **ID4me feature of OpenID connect app available even when disabled ** — [Nextcloud](https://hackerone.com/reports/2376929) — 65 upvotes, —
11. **[auth2.zomato.com] Reflected XSS at `oauth2/fallbacks/error` | ORY Hydra an OAuth 2.0 and OpenID Con** — [Eternal](https://hackerone.com/reports/456333) — 50 upvotes, —
12. **(HackerOne SSO-SAML) Login CSRF, Open Redirect, and Self-XSS Possible Exploitation** — [HackerOne](https://hackerone.com/reports/171398) — 43 upvotes, —
13. **Authentication bypass on JetPack SSO manager - Allows to access the administration panel of wordpres** — [Automattic](https://hackerone.com/reports/2037902) — 40 upvotes, —
14. **Accidental Access to Programs Information via SAML Login** — [HackerOne](https://hackerone.com/reports/438306) — 34 upvotes, —
15. **SAML Response Reuse on hackerone.com/users/saml/auth** — [HackerOne](https://hackerone.com/reports/888930) — 25 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPOAUTH.md`*
