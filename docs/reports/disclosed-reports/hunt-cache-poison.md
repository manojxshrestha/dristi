...
1. **DoS on PayPal via web cache poisoning** — [PayPal](https://hackerone.com/reports/622122) — 849 upvotes, $9,700
2. **Web cache poisoning attack leads to user information and more** — [Postmates](https://hackerone.com/reports/492841) — 343 upvotes, $500
3. **Web Cache Poisoning leads to Stored XSS ** — [Glassdoor](https://hackerone.com/reports/1424094) — 133 upvotes, —
4. **Defacement of catalog.data.gov via web cache poisoning to stored DOMXSS** — [GSA Bounty](https://hackerone.com/reports/303730) — 92 upvotes, $750
5. **https://themes.shopify.com::: Host header web cache poisoning lead to DoS** — [Shopify](https://hackerone.com/reports/1096609) — 81 upvotes, $2,900
6. **Web Cache Poisoning leads to XSS and DoS** — [Glassdoor](https://hackerone.com/reports/1621540) — 71 upvotes, —
7. **web cache deception in https://tradus.com lead to name/user_id enumeration and other info** — [OLX](https://hackerone.com/reports/537564) — 63 upvotes, —
8. **Web Cache Deception** — [Glassdoor](https://hackerone.com/reports/2265400) — 62 upvotes, —
9. **[https://www.glassdoor.com] -  Web Cache Deception Leads to gdtoken Disclosure ** — [Glassdoor](https://hackerone.com/reports/1343086) — 60 upvotes, —
10. **CSRF-tokens on pages without no-cache headers, resulting in ATO when using CloudFlare proxy (Web Cac** — [Discourse](https://hackerone.com/reports/260697) — 56 upvotes, —
11. **Web Cache Deception Attack (XSS)** — [Discourse](https://hackerone.com/reports/394016) — 50 upvotes, $256
12. **Shopify.com Web Cache Deception vulnerability leads to personal information and CSRF tokens leakage** — [Shopify](https://hackerone.com/reports/1271944) — 47 upvotes, $800
13. **Web cache deception attack on https://open.vanillaforums.com/messages/all** — [Vanilla](https://hackerone.com/reports/593712) — 47 upvotes, $150
14. **Web Cache Deception vulnerability on algolia.com leads to personal information leakage** — [Algolia](https://hackerone.com/reports/1530066) — 46 upvotes, $400
15. **Web Cache poisoning attack leads to User information Disclosure and more** — [Lyst](https://hackerone.com/reports/631589) — 45 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPWEBCACHE.md`*
