...
1. **RCE on Steam Client via buffer overflow in Server Info** — [Valve](https://hackerone.com/reports/470520) — 1287 upvotes, —
2. **Potential pre-auth RCE on Twitter VPN** — [X / xAI](https://hackerone.com/reports/591295) — 1237 upvotes, $20K
3. **RCE via npm misconfig -- installing internal libraries from the public registry** — [PayPal](https://hackerone.com/reports/925585) — 931 upvotes, $30K
4. **H1514 Remote Code Execution on kitcrm using bulk customer update of Priority Products** — [Shopify](https://hackerone.com/reports/422944) — 829 upvotes, —
5. **Remote Code Execution on www.semrush.com/my_reports on Logo upload** — [Semrush](https://hackerone.com/reports/403417) — 822 upvotes, —
6. **Git flag injection - local file overwrite to remote code execution** — [GitLab](https://hackerone.com/reports/658013) — 777 upvotes, $12K
7. **RCE and Complete Server Takeover of http://www.█████.starbucks.com.sg/** — [Starbucks](https://hackerone.com/reports/502758) — 571 upvotes, —
8. **Remote Code Execution in Slack desktop apps + bonus** — [Slack](https://hackerone.com/reports/783877) — 506 upvotes, —
9. **RCE when removing metadata with ExifTool** — [GitLab](https://hackerone.com/reports/1154542) — 504 upvotes, $20K
10. **SQL injection on contactws.contact-sys.com in TScenObject action ScenObjects leads to remote code ex** — [QIWI](https://hackerone.com/reports/816254) — 475 upvotes, —
11. **RCE via unsafe inline Kramdown options when rendering certain Wiki pages** — [GitLab](https://hackerone.com/reports/1125425) — 426 upvotes, $20K
12. **Panorama UI XSS leads to Remote Code Execution via Kick/Disconnect Message** — [Valve](https://hackerone.com/reports/631956) — 417 upvotes, —
13. **Remote code execution on Basecamp.com** — [Basecamp](https://hackerone.com/reports/365271) — 415 upvotes, $5,000
14. **RCE via the DecompressedArchiveSizeValidator and Project BulkImports (behind feature flag)** — [GitLab](https://hackerone.com/reports/1609965) — 370 upvotes, $34K
15. **Multiple bugs leads to RCE on TikTok for Android** — [TikTok](https://hackerone.com/reports/1065500) — 370 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPRCE.md`*
