...
1. **Confidential data of users and limited metadata of programs and reports accessible via GraphQL** — [HackerOne](https://hackerone.com/reports/489146) — 1028 upvotes, —
2. **Email address of any user can be queried on Report Invitation GraphQL type when username is known** — [HackerOne](https://hackerone.com/reports/792927) — 669 upvotes, —
3. **IDOR - Delete all Licenses and certifications from users account using CreateOrUpdateHackerCertifica** — [HackerOne](https://hackerone.com/reports/2122671) — 381 upvotes, $12K
4. **Private list members disclosure via GraphQL** — [X / xAI](https://hackerone.com/reports/885539) — 344 upvotes, —
5. **SSRF in graphQL query (pwapi.ex2b.com)** — [EXNESS](https://hackerone.com/reports/1864188) — 254 upvotes, $3,000
6. **Github Apps can use Scoped-User-To-Server Tokens to Obtain Full Access to User's Projects in Project** — [GitHub](https://hackerone.com/reports/1711938) — 197 upvotes, —
7. **IDOR on GraphQL queries BillingDocumentDownload and BillDetails** — [Shopify](https://hackerone.com/reports/2207248) — 176 upvotes, $5,000
8. **Disclosure of `payment_transactions` for programs via GraphQL query** — [HackerOne](https://hackerone.com/reports/707433) — 176 upvotes, —
9. **GraphQL AdminGenerateSessionPayload is leaked to staff with no permission** — [Shopify](https://hackerone.com/reports/898528) — 173 upvotes, —
10. **SQL injection in GraphQL endpoint through embedded_submission_form_uuid parameter** — [HackerOne](https://hackerone.com/reports/435066) — 172 upvotes, —
11. **DOS via Mutation Aliasing in GraphQL Account Recovery Phone Number Verification API** — [HackerOne](https://hackerone.com/reports/3287208) — 158 upvotes, $12K
12. **Undocumented `fileCopy` GraphQL API** — [Shopify](https://hackerone.com/reports/981472) — 154 upvotes, $2,000
13. **Team object in GraphQL disclosed private_comment** — [HackerOne](https://hackerone.com/reports/978143) — 144 upvotes, $2,500
14. **Bug in GraphQL and API integration leads to limited user address disclosure** — [Starbucks](https://hackerone.com/reports/473742) — 143 upvotes, —
15. **Unauthorized user can obtain `report_sources` attribute through Team GraphQL object** — [HackerOne](https://hackerone.com/reports/770209) — 141 upvotes, $2,500


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPGRAPHQL.md`*
