...
1. **2FA bypass by sending blank code** — [Glassdoor](https://hackerone.com/reports/897385) — 303 upvotes, —
2. **2FA Bypass leads to  impersonation of legimate users** — [Drugs.com](https://hackerone.com/reports/2885636) — 205 upvotes, —
3. **Hacker can bypass 2FA requirement and reporter blacklist through embedded submission form** — [HackerOne](https://hackerone.com/reports/418767) — 204 upvotes, $10K
4. **TikTok 2FA Bypass** — [TikTok](https://hackerone.com/reports/1247108) — 191 upvotes, $1,564
5. **Previously created sessions continue being valid after MFA activation** — [Superhuman (formerly Grammarly)](https://hackerone.com/reports/667739) — 172 upvotes, —
6. **Enable 2FA without verifying the email** — [Moneybird](https://hackerone.com/reports/649533) — 145 upvotes, —
7. **Bypassing HackerOne 2FA due to race condition** — [HackerOne](https://hackerone.com/reports/2598548) — 134 upvotes, —
8. **2FA requirement bypass when inviting team members** — [Omise](https://hackerone.com/reports/3356149) — 97 upvotes, —
9. **Password not checked when disabling 2FA on HackerOne** — [HackerOne](https://hackerone.com/reports/587910) — 93 upvotes, —
10. **Account takeover w/o interaction for a user that doesn't have 2fa enabled via 2fa linking and improp** — [Helium](https://hackerone.com/reports/810880) — 90 upvotes, $100
11. **2FA bypass possible on https://authsvc.singlestore.com** — [SingleStore](https://hackerone.com/reports/3329361) — 87 upvotes, —
12. **Session Doesn't expire after 2fa and also other session can change passsword ** — [SideFX](https://hackerone.com/reports/2234736) — 86 upvotes, $300
13. **“email” MFA mode allows bypassing MFA from victim’s device when the device trust is not expired** — [Superhuman (formerly Grammarly)](https://hackerone.com/reports/665722) — 82 upvotes, $2,500
14. **Information disclosure -\> 2fa bypass -\> POST exploitation ** — [Algolia](https://hackerone.com/reports/1276373) — 75 upvotes, —
15. **2FA doesn't work in "https://insider.razer.com"** — [Razer](https://hackerone.com/reports/701901) — 72 upvotes, $200


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPMFA.md`*
