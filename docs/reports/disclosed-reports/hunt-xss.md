...
1. **Bypass for #488147 enables stored XSS on https://paypal.com/signin again** — [PayPal](https://hackerone.com/reports/510152) — 2675 upvotes, $20K
2. **Reflected XSS on https://www.glassdoor.com/employers/sem-dual-lp/** — [Glassdoor](https://hackerone.com/reports/846338) — 684 upvotes, —
3. **Stored XSS on https://paypal.com/signin via cache poisoning** — [PayPal](https://hackerone.com/reports/488147) — 682 upvotes, $19K
4. **Stored XSS in Wiki pages** — [GitLab](https://hackerone.com/reports/526325) — 621 upvotes, —
5. **Stored XSS on imgur profile** — [Imgur](https://hackerone.com/reports/484434) — 610 upvotes, —
6. **One-click account hijack for anyone using Apple sign-in with Reddit, due to response-type switch + l** — [Reddit](https://hackerone.com/reports/1567186) — 503 upvotes, —
7. **XSS in steam react chat client** — [Valve](https://hackerone.com/reports/409850) — 491 upvotes, $7,500
8. **Reflected XSS in OAUTH2 login flow ** — [LY Corporation](https://hackerone.com/reports/697099) — 486 upvotes, $1,989
9. **Cross-Site-Scripting on www.tiktok.com and m.tiktok.com leading to Data Exfiltration** — [TikTok](https://hackerone.com/reports/968082) — 468 upvotes, —
10. **XSS vulnerable parameter in a location hash** — [Slack](https://hackerone.com/reports/146336) — 453 upvotes, —
11. **Blind XSS on image upload** — [CS Money](https://hackerone.com/reports/1010466) — 444 upvotes, $1,000
...
13. **Stored XSS Vulnerability** — [WordPress](https://hackerone.com/reports/643908) — 402 upvotes, —
14. **[accounts.reddit.com] Redirect parameter allows for XSS** — [Reddit](https://hackerone.com/reports/1962645) — 393 upvotes, $5,000
15. **Reflected XSS on www.hackerone.com and resources.hackerone.com** — [HackerOne](https://hackerone.com/reports/840759) — 386 upvotes, $500


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPXSS.md`*
