...
1. **CSRF on connecting Paypal as Payment Provider** — [Shopify](https://hackerone.com/reports/807924) — 303 upvotes, —
2. **Account Takeover using Linked Accounts due to lack of CSRF protection** — [Rockstar Games](https://hackerone.com/reports/463330) — 237 upvotes, —
3. **Periscope android app deeplink leads to CSRF in follow action** — [X / xAI](https://hackerone.com/reports/583987) — 223 upvotes, $1,540
4. **Chaining Bugs: Leakage of CSRF token which leads to Stored XSS and Account Takeover (xs1.tribalwars.** — [InnoGames](https://hackerone.com/reports/604120) — 186 upvotes, $1,100
5. **Improper CSRF token validation allows attackers to access victim's accounts linked to Hackerone** — [HackerOne](https://hackerone.com/reports/1727221) — 163 upvotes, —
6. **Site wide CSRF affecting both job seeker and Employer account on glassdoor.com** — [Glassdoor](https://hackerone.com/reports/790061) — 162 upvotes, —
7. **CSRF protection bypass in GitHub Enterprise management console** — [GitHub](https://hackerone.com/reports/1497169) — 149 upvotes, $10K
8. **Slack integration setup lacks CSRF protection** — [HackerOne](https://hackerone.com/reports/170552) — 146 upvotes, $2,500
9. **CSRF leads to a stored self xss** — [Imgur](https://hackerone.com/reports/323005) — 143 upvotes, —
10. **Lack of CSRF header validation at https://g-mail.grammarly.com/profile** — [Superhuman (formerly Grammarly)](https://hackerone.com/reports/629892) — 136 upvotes, —
11. **CSRF token validation system is disabled on Stripe Dashboard** — [Stripe](https://hackerone.com/reports/1483327) — 113 upvotes, —
12. **Cross-Site Request Forgery ** — [ownCloud](https://hackerone.com/reports/2041007) — 110 upvotes, —
13. **Cross-Site Request Forgery (CSRF) vulnerability on API endpoint allows account takeovers** — [Khan Academy](https://hackerone.com/reports/419891) — 108 upvotes, —
14. **CSRF Vulnerability on https://signin.rockstargames.com/tpa/facebook/link/** — [Rockstar Games](https://hackerone.com/reports/474833) — 103 upvotes, —
15. **One Click Account takeover using Ouath CSRF bypass by adding Null byte %00 in state parameter on  ww** — [Logitech](https://hackerone.com/reports/1046630) — 98 upvotes, $200


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPCSRF.md`*
