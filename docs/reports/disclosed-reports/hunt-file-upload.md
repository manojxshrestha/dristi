...
1. **Remote Code Execution on www.semrush.com/my_reports on Logo upload** — [Semrush](https://hackerone.com/reports/403417) — 822 upvotes, —
2. **Webshell via File Upload on ecjobs.starbucks.com.cn** — [Starbucks](https://hackerone.com/reports/506646) — 686 upvotes, —
3. **Blind XSS on image upload** — [CS Money](https://hackerone.com/reports/1010466) — 444 upvotes, $1,000
4. **Unrestricted file upload on [ambassador.mail.ru] ** — [Mail.ru](https://hackerone.com/reports/854032) — 404 upvotes, $3,000
5. **[ RCE ] Through stopping the redirect in /admin/* the attacker able to bypass Authentication And Upl** — [Mail.ru](https://hackerone.com/reports/683957) — 340 upvotes, —
6. **SSRF  leaking internal google cloud data through upload function [SSH Keys, etc..]** — [Vimeo](https://hackerone.com/reports/549882) — 273 upvotes, —
7. **Unrestricted file upload leads to Stored XSS** — [Visma Public](https://hackerone.com/reports/808862) — 268 upvotes, $250
8. **Arbitrary File Upload to Stored XSS** — [Visma Public](https://hackerone.com/reports/808821) — 245 upvotes, $250
9. **Unrestricted File Upload Leads to RCE on mobile.starbucks.com.sg** — [Starbucks](https://hackerone.com/reports/1027822) — 244 upvotes, —
10. **Admin Management - Login Using Default Password - Leads to Image Upload Backdoor/Shell** — [Razer](https://hackerone.com/reports/699030) — 199 upvotes, $200
11. **External SSRF and Local File Read via video upload due to vulnerable FFmpeg HLS processing** — [TikTok](https://hackerone.com/reports/1062888) — 156 upvotes, $2,727
12. **Unrestricted file upload in www.semrush.com \> /my_reports/api/v1/upload/image** — [Semrush](https://hackerone.com/reports/748903) — 131 upvotes, —
13. **User can upload files even after closing his account** — [Basecamp](https://hackerone.com/reports/1020371) — 123 upvotes, —
14. **Any user could upload attachments to pentest scoping form they don't have access to** — [HackerOne](https://hackerone.com/reports/2450215) — 118 upvotes, —
15. **Insecure file upload in xiaoai.mi.com Lead to Stored  XSS** — [Xiaomi](https://hackerone.com/reports/882733) — 117 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPUPLOAD.md`*
