...
1. **SQL Injection Extracts Starbucks Enterprise Accounting, Financial, Payroll Database** — [Starbucks](https://hackerone.com/reports/531051) — 790 upvotes, —
2. **SQL injection in https://labs.data.gov/dashboard/datagov/csv_to_json via User-agent ** — [GSA Bounty](https://hackerone.com/reports/297478) — 694 upvotes, —
3. **Time-Based SQL injection at city-mobil.ru** — [Mail.ru](https://hackerone.com/reports/868436) — 631 upvotes, $15K
4. **SQL injection at https://sea-web.gold.razer.com/ajax-get-status.php via txid parameter** — [Razer](https://hackerone.com/reports/819738) — 580 upvotes, $2,000
5. **SQL Injection in https://api-my.pay.razer.com/inviteFriend/getInviteHistoryLog** — [Razer](https://hackerone.com/reports/811111) — 528 upvotes, $2,000
6. **SQL injection on contactws.contact-sys.com in TScenObject action ScenObjects leads to remote code ex** — [QIWI](https://hackerone.com/reports/816254) — 475 upvotes, —
7. **Blind SQL Injection ** — [InnoGames](https://hackerone.com/reports/758654) — 432 upvotes, $2,000
8. **SQL Injection in report_xml.php through countryFilter[] parameter** — [Valve](https://hackerone.com/reports/383127) — 401 upvotes, $25K
9. **SQL injection at fleet.city-mobil.ru** — [Mail.ru](https://hackerone.com/reports/881901) — 372 upvotes, $10K
10. **[windows10.hi-tech.mail.ru]  Blind SQL Injection ** — [Mail.ru](https://hackerone.com/reports/786044) — 330 upvotes, $5,000
11. **[www.zomato.com] SQLi - /php/██████████ - item_id** — [Eternal](https://hackerone.com/reports/403616) — 321 upvotes, $4,500
12. ** SQL Injection on cookie parameter** — [MTN Group](https://hackerone.com/reports/761304) — 320 upvotes, —
13. **SQL Injection at https://sea-web.gold.razer.com/lab/cash-card-incomplete-translog-resend via period-** — [Razer](https://hackerone.com/reports/781205) — 240 upvotes, $2,000
14. **SQL Injection in agent-manager** — [Acronis](https://hackerone.com/reports/962889) — 236 upvotes, —
15. **Blind SQLi leading to RCE, from Unauthenticated access to a test API Webservice** — [Starbucks](https://hackerone.com/reports/592400) — 235 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPSQLI.md`*
