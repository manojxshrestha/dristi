...
1. **H1514 Server Side Template Injection in Return Magic email templates?** — [Shopify](https://hackerone.com/reports/423541) — 408 upvotes, —
2. **Path traversal, SSTI and RCE on a MailRu acquisition ** — [Mail.ru](https://hackerone.com/reports/536130) — 152 upvotes, $2,000
3. **Urgent: Server side template injection via Smarty template allows for RCE** — [Unikrn](https://hackerone.com/reports/164224) — 122 upvotes, —
4. **Reflected XSS and Server Side Template Injection  in all HubSpot CMSes** — [HubSpot Inactive](https://hackerone.com/reports/399462) — 64 upvotes, —
5. **Python : Add query to detect Server Side Template Injection** — [GitHub Security Lab](https://hackerone.com/reports/944359) — 29 upvotes, —
6. **Server Side Template Injection on Name parameter during Sign Up process** — [Glovo](https://hackerone.com/reports/1104349) — 26 upvotes, —
7. **SSTI leads to Command injection** — [curl](https://hackerone.com/reports/3584149) — 24 upvotes, —
8. **[Ruby]: Server Side Template Injection** — [GitHub Security Lab](https://hackerone.com/reports/1928279) — 13 upvotes, $2,300
9. **CodeQL query to detect Server-Side Template Injections (JavaScript)** — [GitHub Security Lab](https://hackerone.com/reports/894872) — 8 upvotes, —
10. **Server-side Template Injection in lodash.js ** — [Node.js third-party modules](https://hackerone.com/reports/904672) — 8 upvotes, —
11. **Server-side template injection at ujs test server** — [Ruby on Rails](https://hackerone.com/reports/942103) — 5 upvotes, —
12. **Java : Add query to detect Server Side Template Injection (SSTI)** — [GitHub Security Lab](https://hackerone.com/reports/1490372) — 4 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPSSTI.md`*
