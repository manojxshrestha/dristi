...
1. **Project Template functionality can be used to copy private project data, such as repository, confide** — [GitLab](https://hackerone.com/reports/689314) — 455 upvotes, $12K
2. **Account takeover through the combination of cookie manipulation and XSS** — [Superhuman (formerly Grammarly)](https://hackerone.com/reports/534450) — 289 upvotes, —
3. **Ethereum account balance manipulation** — [Coinbase](https://hackerone.com/reports/300748) — 274 upvotes, —
4. **SSRF  leaking internal google cloud data through upload function [SSH Keys, etc..]** — [Vimeo](https://hackerone.com/reports/549882) — 273 upvotes, —
5. **Account Takeover via Email ID Change and Forgot Password Functionality** — [New Relic](https://hackerone.com/reports/1089467) — 214 upvotes, $2,048
6. **Blind SQL injection and making any profile comments from any users to disappear using "like" functio** — [Pornhub](https://hackerone.com/reports/363815) — 211 upvotes, —
7. **OLO Total price manipulation using negative quantities** — [Upserve](https://hackerone.com/reports/364843) — 165 upvotes, —
8. **Abusing "Report as abuse" functionality to delete any user's post.** — [Vanilla](https://hackerone.com/reports/411075) — 160 upvotes, $300
9. **Server Side Request Forgery (SSRF) in webhook functionality** — [HackerOne](https://hackerone.com/reports/2301565) — 131 upvotes, $2,500
10. **Business Logic Error – Bypass of OTP Verification During Signup on hover.com** — [Tucows (VDP)](https://hackerone.com/reports/3255473) — 130 upvotes, —
11. **Exploitable live argument in onClick Function leads to Data Leakage of Inactive/Suspended Products** — [TikTok](https://hackerone.com/reports/2295958) — 123 upvotes, —
12. **Unserialize leading to arbitrary PHP function invoke** — [Rockstar Games](https://hackerone.com/reports/210741) — 118 upvotes, —
13. **HTTP Request Smuggling in Transform Rules using hexadecimal escape sequences in the concat() functio** — [Cloudflare Public Bug Bounty](https://hackerone.com/reports/1478633) — 114 upvotes, $6,000
14. **XXE in Site Audit function exposing file and directory contents** — [Semrush](https://hackerone.com/reports/312543) — 114 upvotes, —
15. **Claiming the listing of a non-delivery restaurant through OTP manipulation** — [Eternal](https://hackerone.com/reports/1330529) — 106 upvotes, $3,250


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPBUSINESSLOGIC.md`*
