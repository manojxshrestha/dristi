...
1. **My Expense Report resulted in a Server-Side Request Forgery (SSRF) on Lyft** — [Lyft](https://hackerone.com/reports/885975) — 653 upvotes, —
2. **SSRF in Exchange leads to ROOT access in all instances** — [Shopify](https://hackerone.com/reports/341876) — 576 upvotes, —
3. **Server Side Request Forgery (SSRF) via Analytics Reports** — [HackerOne](https://hackerone.com/reports/2262382) — 514 upvotes, —
4. **Server-Side Request Forgery using Javascript allows to exfill data from Google Metadata** — [Snapchat](https://hackerone.com/reports/530974) — 417 upvotes, —
5. **Server Side Request Forgery (SSRF) at app.hellosign.com leads to AWS private keys disclosure** — [Dropbox](https://hackerone.com/reports/923132) — 360 upvotes, $4,913
6. **SSRF on project import via the remote_attachment_url on a Note** — [GitLab](https://hackerone.com/reports/826361) — 355 upvotes, $10K
7. **Server Side Request Forgery mitigation bypass** — [GitLab](https://hackerone.com/reports/632101) — 347 upvotes, —
8. **SSRF & LFR via on city-mobil.ru** — [Mail.ru](https://hackerone.com/reports/748123) — 343 upvotes, —
9. **Blind SSRF to internal services in matrix preview_link API** — [Reddit](https://hackerone.com/reports/1960765) — 335 upvotes, $6,000
10. **Full Response SSRF via Google Drive** — [Dropbox](https://hackerone.com/reports/1406938) — 302 upvotes, $18K
11. **SSRF  leaking internal google cloud data through upload function [SSH Keys, etc..]** — [Vimeo](https://hackerone.com/reports/549882) — 273 upvotes, —
12. **SSRF on fleet.city-mobil.ru leads to local file read** — [Mail.ru](https://hackerone.com/reports/748069) — 272 upvotes, —
13. **Full read SSRF in www.evernote.com that can leak aws metadata and local file inclusion** — [Evernote](https://hackerone.com/reports/1189367) — 258 upvotes, —
14. **SSRF in graphQL query (pwapi.ex2b.com)** — [EXNESS](https://hackerone.com/reports/1864188) — 254 upvotes, $3,000
15. **SSRF & LFR on city-mobil.ru** — [Mail.ru](https://hackerone.com/reports/748128) — 237 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPSSRF.md`*
