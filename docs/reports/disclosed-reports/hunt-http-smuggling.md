...
1. **Mass account takeovers using HTTP Request Smuggling on https://slackb.com/ to steal session cookies** — [Slack](https://hackerone.com/reports/737140) — 864 upvotes, —
2. **Request smuggling on admin-official.line.me could lead to account takeover** — [LY Corporation](https://hackerone.com/reports/740037) — 563 upvotes, —
3. **Stealing Zomato X-Access-Token: in Bulk using HTTP Request Smuggling on api.zomato.com** — [Eternal](https://hackerone.com/reports/771666) — 558 upvotes, —
4. **Password theft login.newrelic.com via Request Smuggling** — [New Relic](https://hackerone.com/reports/498052) — 490 upvotes, $3,000
5. **HTTP request Smuggling** — [Helium](https://hackerone.com/reports/867952) — 299 upvotes, —
6. **HTTP Request Smuggling via HTTP/2** — [Basecamp](https://hackerone.com/reports/1211724) — 298 upvotes, $7,500
7. **HTTP request smuggling (?) canpol.deti.mail.ru** — [Mail.ru](https://hackerone.com/reports/957881) — 241 upvotes, $5,000
8. **HTTP Request Smuggling on https://labs.data.gov** — [GSA Bounty](https://hackerone.com/reports/726773) — 159 upvotes, $750
9. **HTTP Request Smuggling at app.workbox.dk** — [Visma Public](https://hackerone.com/reports/919988) — 139 upvotes, $500
10. **HTTP Request Smuggling due to CR-to-Hyphen conversion** — [Node.js](https://hackerone.com/reports/922597) — 134 upvotes, —
11. **HTTP Request Smuggling on vpn.lob.com** — [Lob](https://hackerone.com/reports/694604) — 123 upvotes, $500
12. **HTTP Request Smuggling in Transform Rules using hexadecimal escape sequences in the concat() functio** — [Cloudflare Public Bug Bounty](https://hackerone.com/reports/1478633) — 114 upvotes, $6,000
13. **HTTP request smuggling using malformed Transfer-Encoding header** — [Node.js](https://hackerone.com/reports/735748) — 104 upvotes, —
14. **Possibility of Request smuggling attack** — [Internet Bug Bounty](https://hackerone.com/reports/2280391) — 93 upvotes, $4,660
15. **CVE-2024-21733 Apache Tomcat HTTP Request Smuggling (Client- Side Desync) (CWE: 444)** — [Internet Bug Bounty](https://hackerone.com/reports/2327341) — 57 upvotes, $4,660


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPREQUESTSMUGGLING.md`*
