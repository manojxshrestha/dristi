...
1. **IDOR to add secondary users in www.paypal.com/businessmanage/users/api/v1/users** — [PayPal](https://hackerone.com/reports/415081) — 781 upvotes, $10K
2. **IDOR allow access to payments data of any user** — [Nord Security](https://hackerone.com/reports/751577) — 386 upvotes, —
...
4. **Insecure Direct Object Reference (IDOR) - Delete Campaigns  ** — [HackerOne](https://hackerone.com/reports/1969141) — 344 upvotes, —
5. **idor allows you to delete photos and album from a gallery** — [Pornhub](https://hackerone.com/reports/380410) — 266 upvotes, $1,500
6. **Singapore - Account Takeover via IDOR** — [Starbucks](https://hackerone.com/reports/876300) — 257 upvotes, —
7. **Insecure Direct Object Reference (IDOR) Allows Viewing Private Report Details via /bugs.json Endpoin** — [HackerOne](https://hackerone.com/reports/2487889) — 252 upvotes, —
8. **IDOR allows any user to edit others videos** — [Pornhub](https://hackerone.com/reports/681473) — 248 upvotes, $1,500
9. **IDOR: Account Deletion via Session Misbinding – Attacker Can Delete Victim Account** — [Mozilla](https://hackerone.com/reports/3154983) — 232 upvotes, —
10. **An IDOR that can lead to enumeration of a user and disclosure of email and phone number within cashi** — [Unikrn](https://hackerone.com/reports/1966006) — 226 upvotes, $3,000
11. **IDOR delete any Tickets on ads.tiktok.com** — [TikTok](https://hackerone.com/reports/1475520) — 214 upvotes, —
12. **I.D.O.R To Order,Book,Buy,reserve On YELP FOR FREE (UNAUTHORIZED USE OF OTHER USER'S CREDIT CARD)** — [Yelp](https://hackerone.com/reports/391092) — 212 upvotes, —
13. **IDOR vulnerability in unreleased HackerOne Copilot feature** — [HackerOne](https://hackerone.com/reports/2218334) — 204 upvotes, —
14. **IDOR allows an attacker to modify the links of any user** — [Reddit](https://hackerone.com/reports/1661113) — 202 upvotes, —
15. **IDOR when editing users leads to Account Takeover without User Interaction at CrowdSignal** — [Automattic](https://hackerone.com/reports/915114) — 200 upvotes, —


*Full reference: `~/dristi/docs/reports/hackerone-reports/tops_by_bug_type/TOPTOPIDOR.md`*
