...
This agent has a corresponding reference library at `knowledge/payloads/Insecure Deserialization/` (61 lines).
...
2. **Study the pattern library:** `~/dristi-reports/disclosed-reports/hunt-deserialization.md` — curated techniques with HTTP request/response examples
...
- **Pattern Library:** `~/dristi-reports/disclosed-reports/hunt-deserialization.md`
