...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="WSTG-INPV-10")`
7. **Track coverage** → `track_test(engagement_id, test_id="WSTG-INPV-10", status="completed", notes=...)`
