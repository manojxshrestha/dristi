...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CONF-05 (Java/Spring Config)")`
7. **Track coverage** → `track_test(engagement_id, test_id="CONF-05 (Java/Spring Config)", status="completed", notes=...)`
