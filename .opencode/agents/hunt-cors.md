...
2. **Study the pattern library:** `~/dristi-reports/disclosed-reports/hunt-cors.md` — curated techniques with HTTP request/response examples
...
- **Pattern Library:** `~/dristi-reports/disclosed-reports/hunt-cors.md`
