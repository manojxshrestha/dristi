...
5. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="All phases (Operator Guidance)")`
6. **Track coverage** → `track_test(engagement_id, test_id="All phases (Operator Guidance)", status="completed", notes=...)`
