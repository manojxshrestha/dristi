...
5. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="INFO-03 through INFO-10 (Recon Techniques)")`
6. **Track coverage** → `track_test(engagement_id, test_id="INFO-03 through INFO-10 (Recon Techniques)", status="completed", notes=...)`
