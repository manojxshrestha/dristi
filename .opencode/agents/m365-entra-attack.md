...
5. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="ATHN-11 (Cloud Auth)")`
6. **Track coverage** → `track_test(engagement_id, test_id="ATHN-11 (Cloud Auth)", status="completed", notes=...)`
