...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="INPV-10 (Prototype Pollution)")`
7. **Track coverage** → `track_test(engagement_id, test_id="INPV-10 (Prototype Pollution)", status="completed", notes=...)`
