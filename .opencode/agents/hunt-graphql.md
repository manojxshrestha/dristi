...
This agent has a corresponding reference library at `knowledge/payloads/GraphQL Injection/` (496 lines).
...
1. **Read the report index:** `~/dristi-reports/hackerone-reports/graphql.md` — scan top-upvoted reports for real-world payloads, bypass techniques, and bounty benchmarks
2. **Study the pattern library:** `~/dristi-reports/disclosed-reports/hunt-graphql.md` — curated techniques with HTTP request/response examples and detection methods
...
**Full list:** `~/dristi-reports/hackerone-reports/graphql.md` (71 reports)
...
- **HackerOne Reports:** `~/dristi-reports/hackerone-reports/graphql.md` — per-class disclosed reports
- **HackerOne Master Index:** `~/dristi-reports/hackerone-reports/INDEX.md` — all classes
- **Pattern Library:** `~/dristi-reports/disclosed-reports/hunt-graphql.md` (exists)
