...
This agent has a corresponding reference library at `knowledge/payloads/Cross-Site Request Forgery/` (163 lines).
...
1. **Read the report index:** `~/dristi-reports/hackerone-reports/csrf.md` — scan top-upvoted reports for real-world payloads, bypass techniques, and bounty benchmarks
2. **Study the pattern library:** `~/dristi-reports/disclosed-reports/hunt-csrf.md` — curated techniques with HTTP request/response examples and detection methods
...
**Full list:** `~/dristi-reports/hackerone-reports/csrf.md` (475 reports)
...
- **HackerOne Reports:** `~/dristi-reports/hackerone-reports/csrf.md` — per-class disclosed reports
- **HackerOne Master Index:** `~/dristi-reports/hackerone-reports/INDEX.md` — all classes
- **Pattern Library:** `~/dristi-reports/disclosed-reports/hunt-csrf.md` (exists)
