...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CONF-10 (Container Security)")`
7. **Track coverage** → `track_test(engagement_id, test_id="CONF-10 (Container Security)", status="completed", notes=...)`
