...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CONF-11 (CI/CD Security)")`
7. **Track coverage** → `track_test(engagement_id, test_id="CONF-11 (CI/CD Security)", status="completed", notes=...)`
