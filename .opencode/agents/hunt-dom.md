...
5. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="WSTG-CLNT-01")`
6. **Track coverage** → `track_test(engagement_id, test_id="WSTG-CLNT-01", status="completed", notes=...)`
