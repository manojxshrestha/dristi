...
1. **Read the methodology** → `get_wstg_test("WSTG-ATHZ-02")` for baseline technique guidance
2. **Check related prompt** → read `prompts/authorization.md` for Dristi-specific workflow
