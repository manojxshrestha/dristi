...
This agent has a corresponding reference library at `payloads-reference/LDAP Injection/` (175 lines).
...
2. **Study the pattern library:** `~/dristi/docs/disclosed-reports/hunt-ldap.md` — curated techniques with HTTP request/response examples
...
- **Pattern Library:** `~/dristi/docs/disclosed-reports/hunt-ldap.md`
