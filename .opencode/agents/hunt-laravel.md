...
5. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CONF-04 (PHP Config)")`
6. **Track coverage** → `track_test(engagement_id, test_id="CONF-04 (PHP Config)", status="completed", notes=...)`
