...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CONF-04 (Node.js Config)")`
7. **Track coverage** → `track_test(engagement_id, test_id="CONF-04 (Node.js Config)", status="completed", notes=...)`
