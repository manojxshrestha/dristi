...
2. **Study the pattern library:** `~/dristi/docs/disclosed-reports/hunt-brute-force.md` — curated techniques with HTTP request/response examples
...
- **Pattern Library:** `~/dristi/docs/disclosed-reports/hunt-brute-force.md`
