...
1. **Read the methodology** → `get_wstg_test("WSTG-INPV-03")` for baseline technique guidance
...
- **Bypass Patterns**: WAF/filter evasion specific to RCE
...
When hunting **Remote Code Execution (RCE)**, use these resources BEFORE and DURING testing:
...
- **Fetch a report when stuck:** If a test shows promise but you need a payload/bypass idea, use `webfetch` to pull the full HackerOne disclosure:
  ```
  webfetch https://hackerone.com/reports/470520
  ```
...
### Top 5 Most-Upvoted Remote Code Execution (RCE) Reports

| # | Report ID | Title |
|---|-----------|-------|
| 1 | [#470520] | [RCE on Steam Client via buffer overflow in Server Info](https://hackerone.com/reports/470520) |
| 2 | [#591295] | [Potential pre-auth RCE on Twitter VPN](https://hackerone.com/reports/591295) |
| 3 | [#925585] | [RCE via npm misconfig -- installing internal libraries from the public...](https://hackerone.com/reports/925585) |
...
webfetch https://hackerone.com/reports/925585
```
