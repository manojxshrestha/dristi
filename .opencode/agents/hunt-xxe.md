...
1. **Read the methodology** → `get_wstg_test("WSTG-INPV-08")` for baseline technique guidance
...
- **Bypass Patterns**: WAF/filter evasion specific to XXE
...
When hunting **XML External Entities (XXE)**, use these resources BEFORE and DURING testing:
...
- **Fetch a report when stuck:** If a test shows promise but you need a payload/bypass idea, use `webfetch` to pull the full HackerOne disclosure:
  ```
  webfetch https://hackerone.com/reports/500515
  ```
...
### Top 5 Most-Upvoted XML External Entities (XXE) Reports

| # | Report ID | Title |
|---|-----------|-------|
| 1 | [#500515] | [XXE at ecjobs.starbucks.com.cn/retail/hxpublic_v6/hxdynamicpage6.aspx](https://hackerone.com/reports/500515) |
| 2 | [#505947] | [XXE on pulse.mail.ru](https://hackerone.com/reports/505947) |
| 3 | [#248668] | [XXE on sms-be-vip.twitter.com in SXMP Processor](https://hackerone.com/reports/248668) |
...
```bash
webfetch https://hackerone.com/reports/500515
webfetch https://hackerone.com/reports/505947
webfetch https://hackerone.com/reports/248668
```
