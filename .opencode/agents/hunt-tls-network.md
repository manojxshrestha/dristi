...
6. **Log findings** → `findings_add_vuln(engagement_id, title, severity, ..., test_id="CRYP-01 (Weak TLS)")`
7. **Track coverage** → `track_test(engagement_id, test_id="CRYP-01 (Weak TLS)", status="completed", notes=...)`
