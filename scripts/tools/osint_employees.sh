...
#
# Usage:
#   scripts/tools/osint_employees.sh <target.com>
#   scripts/tools/osint_employees.sh <target.com> --company "Acme Corp" --with-linkedin
#   scripts/tools/osint_employees.sh <target.com> --sources bing,duckduckgo,crtsh --limit 200
# =============================================================================
