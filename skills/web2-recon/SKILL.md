...
./scripts/tools/auto_recon.sh $TARGET
...
# Skip slow steps:
./scripts/tools/auto_recon.sh $TARGET --skip dns,github,vhost,dir,zone
```

### Output structure (auto-managed)

```
runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/
...
cat runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/crawl/crawledurls.txt | grep -E "[?&](id|user|file|path|url|redirect|next|src|token|key|api_key)=" | tee runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/params/interesting-params.txt

# API endpoints
cat runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/crawl/crawledurls.txt | grep -E "/api/|/v1/|/v2/|/v3/|/graphql|/rest/|/gql" | tee runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/params/api-endpoints.txt

# File upload endpoints
cat runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/crawl/crawledurls.txt | grep -E "upload|file|attachment|document|image|avatar|photo|media" | tee runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/params/uploads.txt

# Admin/internal paths
cat runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/crawl/crawledurls.txt | grep -E "/admin|/internal|/debug|/test|/staging|/dev|/management|/console" | tee runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/params/admin-paths.txt

# Authentication endpoints
cat runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/crawl/crawledurls.txt | grep -E "/oauth|/login|/auth|/sso|/saml|/oidc|/callback|/token" | tee runtime/engagements/${ENGAGEMENT_ID:-default-engagement}/recon/$TARGET/params/auth-paths.txt
```
